...
/**
 * True for exactly the alerts getNotificationVisual renders with the
 * accident-risk 🚨/🚧 treatment (Critical severity, the "Accident"
 * category, or High-severity Weather). Used to group the notification
 * dropdown into an "Accident Risk" section separate from ordinary
 * congestion/weather/road-work alerts, without duplicating the
 * classification rules that already live in getNotificationVisual.
 */
export function isAccidentRiskAlert(alert) {
